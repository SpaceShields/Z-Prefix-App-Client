...
export default function Home() {
  ...
  return (
    <>
      <p className="text-center my-2 mt-8 text-6xl font-exo">SUPRA<span className="text-[#2FA8FA]">VAULT</span></p>
      ...
      <div className="flex-between w-10/12 justify-self-center">
        ...
        <div className='flex gap-1'>
          <button className=' p-2 rounded-lg hover:text-[#2FA8FA]' onClick={() => setTableView(false)}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
            </svg>
          </button>
          <button className=' p-2 rounded-lg hover:text-[#2FA8FA]' onClick={() => setTableView(true)}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
      ...
      {
        tableView ? 
        <div className='w-10/12 px-6 py-2 mb-10 justify-self-center shadow-md shadow-black rounded-xl'>
